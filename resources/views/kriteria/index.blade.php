...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <!-- @if (auth()->user()->level == 'admin')
            <a href="{{ route('kriteria.create') }}" class="btn btn-info mb-3 ml-3">Tambah Kriteria</a>
        ...
        @if (auth()->user()->level == 'admin')
            <div class="d-flex justify-content-start align-items-center mb-3 ml-3">
                <a href="{{ route('kriteria.create') }}" class="btn btn-info mr-2">Tambah Kriteria</a>
                <a class="btn btn-success mr-2" href="{{ route('kriteria') }}">Tampilkan semua Kriteria</a>
                <form class="form-inline my-2" method="get" action="{{ route('kriteria.search') }}">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control" id="search" placeholder="Masukkan Pencarian">
                        <div class="input-group-append">
